...
//              String path = FileUtils.getPath(ActVideoTrimmer.this, uri);
                ...
                //String path="/storage/emulated/0/Android/data/com.gowtham.videotrimmer/files/TrimmedVideo/trimmed_video_2022_1_17_20_49_27.mp4";;
                uri = Uri.parse(path);
                runOnUiThread(() -> {
    ...
    private String[] getCompressionCmd() {
        ...
        if (compressOption.getWidth() != 0 || compressOption.getHeight() != 0
                || !compressOption.getVideoBitrate().equals("0k")) {
            return new String[]{"-ss", TrimmerUtils.formatCSeconds(lastMinValue),
                    ...
                    "-vcodec", "mpeg4", "-b:v",
                    compressOption.getVideoBitrate(), "-b:a", compressOption.audioBitrate/*"48000"*/, "-ac", "2", "-ar",
                    "22050", "-t",
